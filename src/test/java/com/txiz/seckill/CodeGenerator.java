...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("C:\\Users\\85395\\Desktop\\Project\\Seckill" + "/src/main/java");
        gc.setAuthor("Txiz");
        ...
        // 表的名称
        strategy.setInclude("tb_user","tb_stock","tb_order");
        //数据库表映射到实体的命名策略
